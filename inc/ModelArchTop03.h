...
#ifndef DEEPPOINTV1_MODELARCHTOP03_H
#define DEEPPOINTV1_MODELARCHTOP03_H
...
class ModelArchTop03 {
public:
    ModelArchTop03(int dataset_offset, int batchsize, int pointcount, int knn_k);
...
#endif //DEEPPOINTV1_MODELARCHTOP03_H
