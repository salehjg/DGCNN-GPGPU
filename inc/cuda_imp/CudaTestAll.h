...
#ifndef DEEPPOINTV1_CUDATESTALL_H
#define DEEPPOINTV1_CUDATESTALL_H
...
class CudaTestAll {
public:
    CudaTestAll(int dataset_offset, int batchsize, int pointcount, int knn_k);
...
#endif //DEEPPOINTV1_CUDATESTALL_H
